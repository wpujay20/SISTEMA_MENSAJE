...
<html lang="es">
    ...
    <body>
        ...
        <form name="formInsertar" id="formInsertar" action="../CONTROLADOR/Registro_Login_Controlador.php?op=3" method="post">


            <div style="padding: 30px 200px 100px 200px ; ">

                <div class="modal-header">
                    <strong> <h4 class="modal-title" id="exampleModalLabel">Agregar Trabajador (Colaborador, Jefe, RR.HH)</h4></strong>
                </div>
